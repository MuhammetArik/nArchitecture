...
namespace WebAPI.Controllers
{
    ...
    public class ModelsController : BaseController
    {
        ...
        {
            GetListModelByDynamicQuery getListModelByDynamicModelQuery = new GetListModelByDynamicQuery { PageRequest = pageRequest , Dynamic = dynamic };
            ModelListModel result = await Mediator.Send(getListModelByDynamicModelQuery);
            return Ok(result);
        }
    }
}
